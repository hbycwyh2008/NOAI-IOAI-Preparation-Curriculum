...
- unique phase-local linked packets: 95;
...
`_Lesson_Library` contains 96 remaining lesson files for remediation, alternative explanations, deeper domain work, reproductions, mocks, and optional competition sprints. These files are not part of the canonical Session count unless a teacher records a cohort-specific extension.
