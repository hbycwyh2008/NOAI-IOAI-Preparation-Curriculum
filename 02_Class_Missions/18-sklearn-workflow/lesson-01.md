# Mission 18.1 — Complete Scikit-learn Workflow
...
By the end of this mission, you can explain the core ideas in **split, preprocessing, pipeline, baseline, validation, metrics** and demonstrate them through a paper-based or computational task.
...
Build a reproducible tabular baseline.

## Independent Task

Rebuild the workflow on a second dataset under a time limit.
