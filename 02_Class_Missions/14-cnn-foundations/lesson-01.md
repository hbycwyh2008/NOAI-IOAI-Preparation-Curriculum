# Mission 14.1 — CNNs, Convolution, Pooling, and Output Functions
...
By the end of this mission, you can explain the core ideas in **kernels, stride, padding, pooling, fully connected, ReLU, softmax, loss** and demonstrate them through a paper-based or computational task.
...
Calculate simple output shapes and identify layer roles.

## Independent Task

Build a small CNN diagram and explain the full forward path.
