# Mission 04.1 — AI Paradigms, Turing Test, and Ethics
...
By the end of this mission, you can explain the core ideas in **symbolism, connectionism, behaviourism, risks, bias, privacy** and demonstrate them through a paper-based or computational task.
...
Explain an AI ethics scenario with cause, impact, and mitigation.

## Independent Task

Write a structured response to an algorithmic-bias case.
