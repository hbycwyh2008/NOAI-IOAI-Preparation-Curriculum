# Mission 05.1 — Supervised, Unsupervised, and Reinforcement Learning
...
By the end of this mission, you can explain the core ideas in **regression, classification, clustering, RL states/actions/rewards** and demonstrate them through a paper-based or computational task.
...
Classify unfamiliar tasks by learning paradigm.

## Independent Task

Design one example task for each paradigm and justify it.
