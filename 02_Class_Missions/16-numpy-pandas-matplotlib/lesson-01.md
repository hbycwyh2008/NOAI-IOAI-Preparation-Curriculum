# Mission 16.1 — NumPy, Pandas, and Matplotlib

## Learning Target

By the end of this mission, you can explain the core ideas in **arrays, DataFrames, querying, missing values, plots** and demonstrate them through a paper-based or computational task.
...
Clean and visualise a small dataset.

## Independent Task

Rebuild the workflow from a new CSV without copied cells.
