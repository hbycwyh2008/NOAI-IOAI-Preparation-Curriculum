# Mission 10.1 — Generalisation, Overfitting, and Regularisation
...
By the end of this mission, you can explain the core ideas in **train/validation/test, underfitting, overfitting, L1/L2** and demonstrate them through a paper-based or computational task.
...
Diagnose learning curves and propose remedies.

## Independent Task

Modify a model to reduce overfitting and document evidence.
