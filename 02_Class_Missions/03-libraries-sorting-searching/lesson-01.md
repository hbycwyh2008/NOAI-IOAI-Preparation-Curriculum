...
By the end of this mission, you can explain the core ideas in **modules, CSV, linear search, binary search, simple sorts** and demonstrate them through a paper-based or computational task.
...
Implement linear search and one simple sort without a full solution.
