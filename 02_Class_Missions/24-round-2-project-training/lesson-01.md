# Mission 24.1 — Round 2 Open-Ended Project Workflow
...
By the end of this mission, you can explain the core ideas in **baseline, leaderboard, experiment control, submission validation** and demonstrate them through a paper-based or computational task.
...
Official NOAI 2025 repository supplied by the teacher
...
Complete one end-to-end task within a fixed work block.

## Independent Task

Produce a valid submission before attempting advanced optimisation.
