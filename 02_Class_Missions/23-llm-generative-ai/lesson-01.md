# Mission 23.1 — LLMs, Qwen, Multimodality, and APIs
...
By the end of this mission, you can explain the core ideas in **tokens, next-token prediction, prompting, local inference, API calls** and demonstrate them through a paper-based or computational task.
...
Explain the LLM workflow and make a controlled API/local-model call.

## Independent Task

Build a small question-answering utility with logged inputs/outputs.
