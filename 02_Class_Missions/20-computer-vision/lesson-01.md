# Mission 20.1 — Computer Vision and Transfer Learning
...
By the end of this mission, you can explain the core ideas in **image transforms, CNNs, transfer learning, OpenCV baselines** and demonstrate them through a paper-based or computational task.
...
Compare a traditional image-processing baseline and a learned model.

## Independent Task

Fine-tune a small pretrained model and analyse errors.
