# BML15 70-Minute Lesson Sequence

This folder turns 北京市十一学校《中学机器学习十五讲》 into **14 teachable 70-minute club lessons**.

The sequence is mainly for **NOAI Round 1 A/B** preparation: AI foundations, machine-learning concepts, Python/library awareness, paper-test explanations, and concept-to-evidence reasoning.
...
See `09_Teacher_Planning/BML15_70min_Lesson_Split.md` for the overview, timing templates, and evidence matrix.
