# Mission 21.1 — NLP, Tokenisation, RNNs, and LSTMs
...
By the end of this mission, you can explain the core ideas in **vocabulary, tokenisation, padding, embeddings, RNN, LSTM, text classification** and demonstrate them through a paper-based or computational task.
...
Prepare text data and train or fine-tune a classifier.

## Independent Task

Rebuild a compact text-classification pipeline.
