# Mission 11.1 — Decision Trees and Ensembles
...
By the end of this mission, you can explain the core ideas in **purity, information gain, bagging, random forest, boosting** and demonstrate them through a paper-based or computational task.
...
Explain how a tree chooses a split and compare ensemble types.

## Independent Task

Train a tree and a random forest; compare validation behaviour.
