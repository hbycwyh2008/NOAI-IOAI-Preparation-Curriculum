# Mission 12.1 — Perceptrons and Neural Networks

## Learning Target

By the end of this mission, you can explain the core ideas in **neurons, weights, bias, layers, forward propagation** and demonstrate them through a paper-based or computational task.
...
Trace a tiny forward pass and explain nonlinear representation.

## Independent Task

Draw and calculate a small two-layer network.
