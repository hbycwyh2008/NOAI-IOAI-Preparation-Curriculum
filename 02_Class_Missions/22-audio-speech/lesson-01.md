# Mission 22.1 — Audio Features and Speech Tasks
...
By the end of this mission, you can explain the core ideas in **waveform, sample rate, spectrogram, Mel features, ASR, TTS** and demonstrate them through a paper-based or computational task.
...
Convert audio into model-ready representations.

## Independent Task

Build an audio-classification baseline and inspect mistakes.
